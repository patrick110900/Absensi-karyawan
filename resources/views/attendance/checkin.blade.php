                ...
                @if($attendance)
                    <div class="d-flex align-items-center gap-3 mb-4">
                        ...
                        <div>
                            ...
                            <div style="color:#6B7280;font-size:.85rem;">Jam {{ $attendance->jam_masuk }}</div>
                        </div>
                    </div>
                    <div class="row g-3 mb-4">
                        <div class="col-6">
                            <div style="background:#F8FAFC;border-radius:10px;padding:1rem;border:1px solid #E5E7EB;">
                                ...
                                <div style="font-weight:700;font-size:1.1rem;color:#10B981;">{{ $attendance->jam_masuk ?? '-' }}</div>
                            </div>
                        </div>
                        <div class="col-6">
                            <div style="background:#F8FAFC;border-radius:10px;padding:1rem;border:1px solid #E5E7EB;">
                                <div style="font-size:.74rem;color:#6B7280;margin-bottom:.2rem;">Jam Pulang</div>
                                <div style="font-weight:700;font-size:1.1rem;color:{{ $attendance->jam_pulang ? '#EF4444' : '#9CA3AF' }};">
                                    {{ $attendance->jam_pulang ?? 'Belum' }}
                                </div>
                            </div>
                        </div>
                    </div>
...
<script>
    ...
    async function submit(type) {
        ...
        const url = type === 'checkin'
            ? '{{ route("attendance.do-checkin") }}'
            : '{{ route("attendance.do-checkout") }}';
