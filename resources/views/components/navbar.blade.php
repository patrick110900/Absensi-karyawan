        ...
        <div class="dropdown">
            <button class="dropdown-toggle" data-bs-toggle="dropdown">
                ...
                <div class="d-none d-md-block text-start">
                    <div style="font-size:.83rem;font-weight:600;line-height:1.3;">{{ auth()->user()->name }}</div>
                    <div style="font-size:.7rem;opacity:.6;">{{ ucfirst(auth()->user()->role) }}</div>
                </div>
            ...
            <ul class="dropdown-menu dropdown-menu-end mt-2" style="border-radius:12px;border:1px solid #E5E7EB;min-width:200px;box-shadow:0 8px 30px rgba(0,0,0,.12);">
                <li>
                    <div class="px-3 py-2 border-bottom">
                        ...
                        <div style="font-size:.775rem;color:#6B7280;">{{ auth()->user()->email }}</div>
                    </div>
                </li>
                <li>
